...
class MainActivityTest {
    ...
    fun test_visibility_title_nextButton() {
        ...
        onView(withId(R.id.btnNextActivity))
    ...
    fun test_navSecondaryActivity() {
        ...
        onView(withId(R.id.btnNextActivity)).perform(ViewActions.click())
    ...
    fun test_backPress_toMainActivity() {
        ...
        onView(withId(R.id.btnBack)).perform(ViewActions.click()) // method 1
